        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-white text-2xl font-bold">JobPortal</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/skill-development" className="hover:text-primary transition-colors">Skill Development</Link></li>
              <li><Link to="/counseling" className="hover:text-primary transition-colors">Career Counseling</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-sm">123 Business Park, Sector 62, Chandigarh, India</span>
              </li>
              <li className="flex items-center space-x-2">
                <EnvelopeIcon className="h-5 w-5 text-primary flex-shrink-0" />
                <a href="mailto:support@jobportal.com" className="text-sm hover:text-primary">support@jobportal.com</a>
              </li>
              <li className="flex items-center space-x-2">
                <PhoneIcon className="h-5 w-5 text-primary flex-shrink-0" />
                <a href="tel:+919876543210" className="text-sm hover:text-primary">+91 98765 43210</a>
              </li>
            </ul>
          </div>
        </div>
